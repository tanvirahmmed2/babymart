        ...
        <form onSubmit={handleSubmit} className='w-full flex flex-col items-center justify-between gap-6 text-sm'>
            ...
            <div className='w-full flex flex-col items-center justify-center gap-2'>
                <div className="flex flex-row items-center justify-between w-full">
                    <p onClick={() => handleMethodChange('pickup')} className={`cursor-pointer px-4 py-1 rounded-full border ${data.delivery === 'pickup' ? 'bg-sky-400 text-white' : 'border-gray-300'}`} >Pickup</p>
                    <p onClick={() => handleMethodChange('homedelivery')} className={`cursor-pointer px-4 py-1 rounded-full border ${data.delivery === 'homedelivery' ? 'bg-sky-400 text-white' : 'border-gray-300'}`} >Homde Delivery</p>
                </div>
            ...
            <button className='bg-sky-400 text-white p-1 px-4 rounded-2xl cursor-pointer' type='submit'>Place order</button>
        </form>
    )
}
