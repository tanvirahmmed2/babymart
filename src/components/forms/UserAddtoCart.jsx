...
const UserAddtoCart = ({ product}) => {
  ...
  return (
    <div className='w-full flex flex-col items-center justify-center gap-2'>
      ...
      <button onClick={addtoCart} className='w-full flex flex-row items-center justify-center gap-2 bg-red-300 hover:bg-red-600/70 text-white rounded-lg cursor-pointer'>Cart <CiShoppingCart className='text-xl' /></button>
    </div>
  )
}
